...
module.exports = function createRoutes(selection, cores, preHandlers, postHandlers, options, next) {
  ...
  Object.keys(resources).forEach(function(name) {
    ...
    var routeHandlers = createHandlers(resource, name, preHandlers, postHandlers);
